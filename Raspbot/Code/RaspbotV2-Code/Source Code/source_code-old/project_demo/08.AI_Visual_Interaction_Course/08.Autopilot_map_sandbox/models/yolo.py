...
class Model(nn.Module):
    def __init__(self, cfg='v5Lite-e.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='v5Lite-e.yaml', help='model.yaml')
