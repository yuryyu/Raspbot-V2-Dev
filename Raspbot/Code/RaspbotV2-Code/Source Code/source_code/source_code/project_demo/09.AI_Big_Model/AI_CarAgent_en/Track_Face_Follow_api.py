...
#传入参数 x 和 y轴 Pass in parameters x and y-axis
...
def myTrack_Face_Follow():
    ...
    try:
        while 1:
            ...
            if descore:
                now_aera = w*h
                now_aera = limit_max_vlaue(now_aera,2000,6000)#限制下面积的最小最大 Minimum and maximum area under restriction
                ...
                if target_valuex > -3 and target_valuex < 3:
                    target_valuex = 0 #剔除死区 Eliminate dead zones
