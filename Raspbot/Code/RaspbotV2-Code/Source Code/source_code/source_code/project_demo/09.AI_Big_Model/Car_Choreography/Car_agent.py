from Car_Online_API import QwenVL_api_action
...
获取面前物体/障碍物的距离:Get_dis_obstacle()
...
def Car_Agent_Plan(AGENT_PROMPT='前进3秒,然后转个圈'):
    print('Car Agent Start')
    PROMPT = AGENT_SYS_PROMPT + AGENT_PROMPT
    agent_plan = QwenVL_api_action(PROMPT)
